...
**Schedules** — human-readable cron, relative next fire, and a future-runs timeline. All / Enabled / Disabled filter plus project and agent filters match the Agents list.
