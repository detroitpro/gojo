...
export async function listNotificationChannels(): Promise<Record<string, unknown>> {
  const { data } = await request<{ channels: Record<string, unknown> }>("/notification-channels");
