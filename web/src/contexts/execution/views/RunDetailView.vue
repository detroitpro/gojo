...
import RunActivitySection from "@/contexts/execution/components/RunActivitySection.vue";
import RunArtifactsSection from "@/contexts/execution/components/RunArtifactsSection.vue";
...
const runIsActive = computed(() => {
  ...
  return Boolean(state && !isTerminalRunState(state));
});
  ...
  <div>
    ...
    <template v-else-if="run">
      ...
      <RunActivitySection
        ...
        @update:selected-phase="selectedPhase = $event"
        @update:highlight-activity-id="highlightActivityId = $event"
      />
      ...
      <RunArtifactsSection
        :run="run"
        :artifacts="artifacts"
        :handoff-text="handoffText"
        :handoff-assets="handoffAssets"
        :artifacts-handoff-text="artifactsHandoffText"
        :artifacts-validation-text="artifactsValidationText"
      />
