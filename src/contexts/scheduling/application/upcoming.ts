import { nextOccurrences } from "@/contexts/scheduling/domain/cron";
import { scheduleColorFromId } from "@/contexts/scheduling/domain/schedule-color";
...
export type ListUpcomingSchedulesDeps = {
  listSchedules: (input: {
    limit: number;
    offset: number;
    projectId?: string | null;
...
export function listUpcomingSchedules(
  deps: ListUpcomingSchedulesDeps,
