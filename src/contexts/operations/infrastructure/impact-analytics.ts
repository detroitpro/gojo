...
import {
  ...
  type DashboardImpactCategoryTotal,
  type DashboardImpactRange,
  type DashboardImpactRecentItem,
  type DashboardImpactTotals,
  type DashboardImpactWindow,
} from "@shared/dashboard";

import type { Database } from "@/infrastructure/persistence";

export { parseImpactRange };
export type {
  DashboardImpact,
